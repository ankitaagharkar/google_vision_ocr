            ...
            if values[1][0][1] < prev_y_mid and abs(prev_y_start-values[1][0][1]) <= mod_ht:
                ...
                if line_list:
                    ...
                    if abs(prev_y_mid-values[1][0][1]) < 3:
                        ...
                        closest_word = min(enumerate(line_list[-1]), key = lambda x: values[1][0][0] - x[1][1][1][0] if values[1][0][0] - x[1][1][1][0] > 0 else float('inf'))
            ...
            for w_index,word in enumerate(line): 
                ...
                if c:
                    ...
                    try:
                        ...
                        y_diff = enumerate([x for x in blocks if x[5] == True and abs(x[2] - word[1][0][1]) < (3.25 * x[4])])
                ...
                if columns:
                    ...
                    if val:
                        ...
                        for i, e in reversed(list(enumerate(columns))):
                            if word[1][1][0] > columns[i][3] and (word[1][1][0] <= columns[i][2] or columns[i][2] == 0) and (word[1][0][1] > columns[i][1]):
...
def main():
    pt = paystub_gcv()
    image_path = sys.argv[1] #'/home/mohammad/MJ/virtualenvironment/first/iDocufy/GCV/OneDrive_1_2-8-2018/Bottling Group LLC Paystub 012618.jpg' #

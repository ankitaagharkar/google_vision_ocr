...
class Paystub_details:
    ...
    def get_paystub_date(self, text):
        try:
            ...
            return str(start_date), self.pay_frequency, string_date_value,end_date
        except Exception as E:
            print(E)
    ...
    def get_gross_net_pay(self,path):
        try:
            ...
            # for line in lines:
            #     #print(line)
            blocks1 = self.paystub_block.all_location_details(path)
            print(blocks1)
            ...
            print(e)
    def get_details(self,text,path):
        try:
            #print(text)
            gross_pay, net_pay = self.get_gross_net_pay(path)
            ...
            start_date,pay_frequency, string_date_value,employment_Start_date = self.get_paystub_date(text)
            employer_name=self.employer_name(text,employer_street)
            employee_name=self.employee_name(text,employee_street)
            return employer_full_address, employer_street, employer_state, employer_zipcode, employer_city,employee_full_address, employee_street, employee_state, employee_zipcode, employee_city,start_date,pay_frequency, string_date_value,employer_name,employee_name,gross_pay,net_pay,employment_Start_date
        except Exception as e:
            print(e)

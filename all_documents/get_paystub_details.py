...
class Paystub_details:
    ...
    def get_gross_net_pay(self,path,description,result):
        try:
            ...
            blocks1,text = paystub_block.all_location_details(path,description,result,filename)
    ...
    def get_details(self,text,path,description,result):
        try:
            ...
            employer_address, employee_address, employee_street, employer_street, employee_city, employer_city, employer_state, employee_state,employee_zipcode,employer_zipcode=self.paystub_address(text)
            ...
            employer_name, employee_name=self.paystub_name(text,employer_street,employee_street)
